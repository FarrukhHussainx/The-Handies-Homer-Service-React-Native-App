...
export default function Plumber({ navigation }) {
  ...
  const displayi = (item) => {
    if (item.checkbox[0] && item.checkbox[0].name === "Plumber") {
      return (
        <TouchableOpacity
          onPress={() =>
    ...
    if (item.checkbox[1] && item.checkbox[1].name === "Plumber") {
      return (
        <TouchableOpacity
          onPress={() =>
            navigation.navigate("Order", {
    ...
    } else if (item.checkbox[2] && item.checkbox[2].name === "Plumber") {
      return (
        <TouchableOpacity
          onPress={() =>
            navigation.navigate("Order", {
    ...
    if (item.checkbox[3] && item.checkbox[3].name === "Plumber") {
      return (
        <TouchableOpacity
          onPress={() =>
            navigation.navigate("Order", {
