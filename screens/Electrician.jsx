...
export default function Electrician({ navigation }) {
  ...
  const displayi = (item) => {
    if (item.checkbox[0] && item.checkbox[0].name === "Electrician") {
      return (
        <TouchableOpacity
          onPress={() =>
    ...
    if (item.checkbox[1] && item.checkbox[1].name === "Electrician") {
      return (
        <TouchableOpacity
          onPress={() =>
            navigation.navigate("Order", {
    ...
    } else if (item.checkbox[2] && item.checkbox[2].name === "Electrician") {
      return (
        <TouchableOpacity
          onPress={() =>
            navigation.navigate("Order", {
    ...
    if (item.checkbox[3] && item.checkbox[3].name === "Electrician") {
      return (
        <TouchableOpacity
          onPress={() =>
            navigation.navigate("Order", {
